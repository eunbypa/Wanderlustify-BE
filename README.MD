...
Content-Type: application/json<br>
<br>
DELETE /admin/1234<br>
응답<br>

Copy code<br>
HTTP/1.1 200 OK<br>
위의 예시는 API 엔드포인트, HTTP 메서드, 요청 및 응답 형식, 매개변수, 응답 상태코드 등을 명시한 API 문서입니다. 실제 사용할 요청과 응답 형식은 해당 API의 비즈니스 로직과 요구사항에 맞게 작성하시면 됩니다.
